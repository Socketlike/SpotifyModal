import { elementUtilities } from "./common";
import { FadeAnimations } from "./types";
...
/* Play & pause icon */
const play = e("path", "spotify-modal-play-icon-path", {
  ...a.path,
  d: "M8,5.14V19.14L19,12.14L8,5.14Z",
}) as SVGPathElement;
const pause = e("path", "spotify-modal-pause-icon-path", {
  ...a.path,
...
/* Repeat icon */
const repeatAll = e("path", "spotify-modal-repeat-all-path", {
  ...a.path,
  d: "M17,17H7V14L3,18L7,22V19H19V13H17M7,7H17V10L21,6L17,2V5H5V11H7V7Z",
}) as SVGPathElement;
const repeatOne = e("path", "spotify-modal-repeat-one-path", {
  ...a.path,
...
const shuffle = e("svg", "spotify-modal-shuffle-icon", "color: var(--text-normal)", a.svg, [
  shuffleTitle,
  e("path", "spotify-modal-shuffle-icon-path", {
    ...a.path,
...
const skipPrevious = e(
  ...
  a.svg,
  [
    e("path", "spotify-modal-skip-previous-icon-path", {
      ...a.path,
...
const skipNext = e("svg", "spotify-modal-skip-next-icon", "color: var(--text-normal)", a.svg, [
  e("path", "spotify-modal-skip-next-icon-path", {
    ...a.path,
